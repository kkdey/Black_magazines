---
title: 'word2vec association analysis : Ebony'
author: "Kushal K Dey"
date: "4/11/2018"
...
interest for the Ebony magazine. We also track the associations across time.
...
```{r}
trend_plotter(c("negro", "negroes", "negro"), "struggle")
```
