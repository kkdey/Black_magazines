...
```{r}
trend_plotter(c("blacks"), c("musician", "song", "songs", "sang"), model_list_1)
```

## [Black] vs music

```{r}
trend_plotter(c("blacks"), c("musician", "song", "songs", "sang"), model_list_2)
```
...
```{r}
trend_plotter(c("negros", "negroes"), c("musician", "song", "songs", "sang"), model_list_2)
```
